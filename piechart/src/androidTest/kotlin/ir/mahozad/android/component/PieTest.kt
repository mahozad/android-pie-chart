...
class PieTest {
    ...
    @Test fun changeLabelsSize() {
        ...
        val height = 1000f
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val pie = Pie(context, width, height, null, null, 0, slices, 0f, labelType, 20f, 0, Typeface.DEFAULT, 0f, 0f, PieChart.IconPlacement.START, null, 0f, false, PieChart.DrawDirection.CLOCKWISE, 0.34f, 0.34f, PieChart.GradientType.SWEEP, 0.3f, null, 3f, PieChart.GapPosition.MIDDLE)

        val duration = measureTimeMillis {
            pie.setLabelsSize(15f)
        }
    ...
    @Test fun changeLabelIconsHeight() {
        ...
        val height = 1000f
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val pie = Pie(context, width, height, null, null, 0, slices, 0f, labelType, 20f, 0, Typeface.DEFAULT, 17f, 0f, PieChart.IconPlacement.START, null, 0f, false, PieChart.DrawDirection.CLOCKWISE, 0.34f, 0.34f, PieChart.GradientType.SWEEP, 0.3f, null, 3f, PieChart.GapPosition.MIDDLE)

        val duration = measureTimeMillis {
            pie.setLabelIconsHeight(23f)
        }
